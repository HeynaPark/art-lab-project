...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        label1 = QLabel("파일 이름 라벨 1")
        image_label1 = QLabel("이미지 라벨 1")
        ...
        label2 = QLabel("파일 이름 라벨 2")
        image_label2 = QLabel("이미지 라벨 2")
        ...
        # event
        button1.clicked.connect(lambda : self.showImageFileDialog(label1, image_label1))
        button2.clicked.connect(lambda : self.showImageFileDialog(label2, image_label2))
    ...
    def showImageFileDialog(self, label_name, label_img):
